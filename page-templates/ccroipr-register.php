				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
	                        ...
	                        <p class="text-danger accordion">Diese Angaben zur Registeranmeldung werden nicht veröffentlicht! &nbsp;<i class="fa fa-chevron-down" aria-hidden="true"></i></p>
						</div>
					</div>
					<div class="col-sm-6 col-md-4 col-lg-4 panel">
						<div class="form-group">							
