	...
	<div class="row">
        ...
        <div class="col-md-12">
            <div class="confirmed-headline text-center mb-30">
                ...
                <div class="mb-30"></div>
                <h4><?php _e('Unter  Hinweis  auf', 'ccroipr'); ?></h4>
                <ul>
                    <li><?php _e('* §80  UrhG,  §9  UWG  (Österreich) sowie.', 'ccroipr'); ?></li>
                    <li><?php _e('* §5  Abs.3 MarkenG (Deutschland) und.', 'ccroipr'); ?></li>
                    <li><?php _e('* Art. 2 Abs. 4 URG (Schweiz).', 'ccroipr'); ?> </li>            
                </ul>
                <h4><?php _e('nehme ich Titelschutz in Anspruch für', 'ccroipr'); ?></h4>
            </div>
        </div>
